 ...
 * a path it can resolve. This bypasses the platform's WSL path translation that turns the UNC
 * preview of a built-in macro into a Linux path at expansion time.
 *
